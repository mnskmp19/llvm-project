; ModuleID = '../llvm/test/Transforms/TestPass/test001.cpp'
source_filename = "../llvm/test/Transforms/TestPass/test001.cpp"
...
define dso_local noundef i32 @main() #0 !dbg !10 {
  ...
  %4 = load i32, i32* %3, align 4, !dbg !19
  %5 = load i32, i32* %2, align 4, !dbg !20
  %6 = add nsw i32 %5, %4, !dbg !20
...
!1 = !DIFile(filename: "../llvm/test/Transforms/TestPass/test001.cpp", directory: "/home/syrmia/workspace/llvm-project/build", checksumkind: CSK_MD5, checksum: "2b9644a1443c2335a60b884261e625ef")
...
!18 = !DILocation(line: 2, column: 16, scope: !10)
!19 = !DILocation(line: 3, column: 10, scope: !10)
!20 = !DILocation(line: 3, column: 7, scope: !10)
